    ...
    <div class="centre">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><a href="pay_payment.php?payment_id=' . $row['payment_id'] . '"><button class="btn-custom btn-blue btn-small"><i class="fa-solid fa-angles-right fa-lg"></i> Go to Pay</button></a></td>';
                echo '</tr>';
            }
