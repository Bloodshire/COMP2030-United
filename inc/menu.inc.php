...
<div id="menu" class="sidenav">
    ...
    <li><a href="logbook.php"><i class="fa-xl fa-solid fa-car-side"></i><br>Log Drive</a></li>
    ...
    <li><a href="mapreview.php"><i class="fa-xl fa-solid fa-location-dot"></i><br>Map Review</a></li>
